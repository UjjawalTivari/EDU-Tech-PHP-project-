...
?>	
	 <h1>Registration Form</h1>
        ...
        <table>
            ...
            <tr>
                <td>School Name: </td>
                <td><input type="text" name="school" value="<?php if($isSubmitted) {
                        echo $_POST['school'];
                    }?>"/> </td>
                <td><?php if($isSubmitted) {
                    $validSchoolName = validateComplete($_POST['school']);
                }?></td>
            </tr>

            <tr>
                <td>School Board: </td>
                <td><input type="text" name="schoolBoard" value="<?php if($isSubmitted) {
                        echo $_POST['schoolBoard'];
                    }?>"/> </td>
                <td><?php if($isSubmitted) {
                        $validSchoolBoardName = validateComplete($_POST['schoolBoard']);
                    }?></td>
            </tr>
...
<a href='localhost:8080/EQAOProject-master/registrationverification.php?token=".$token."&userName=".$userName."'>Complete Registration </a> <br>
Or, paste the following url into your browser: localhost:8080/EQAOProject-master/registrationverification.php?token=".$token."&userName=".$userName);
