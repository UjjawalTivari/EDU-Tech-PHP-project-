...
//convert HTML into a basic plain-text alternative body
        $mail->msgHTML("<h2>Dear Edutech user, <br> Please follow the link to update your password: <a href=localhost/finalProject/UpdatePassword.php?userName=".$_POST['userName']."&token=".$token.">Update Password </a> <br> 
Or, paste this link into your browser: localhost/finalProject/UpdatePassword.php?userName=".$_POST['userName']."&token=".$token."</h2>");

//Replace the plain text body with one created manually
        $mail->AltBody = "Dear Edutech user, please click or paste the following url into your browser to update your password: localhost/finalProject/UpdatePassword.php?userName=".$_POST['userName']."&token=".$token;
