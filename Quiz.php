...
public static function retrieve_questions($quizNum){
	...
	/* If your machine or brower does not run quiz.php properly, uncomment the lines below and comment out the next line instead */
	$jresults = json_encode(Database::utf8ize($results));
