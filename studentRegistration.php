          ...
          <div class="form-box-inner">
            ...
            <div class="row">
              <div class="form-container">
                <form class="resetpass-form" method="post" action="studentRegistration.php?" >

                  <?php
                  $nameErr=$pwdErr=$fnameErr=$lnameErr=$emailErr='';
                  if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    if($validUserName&&$validPassword&&$validFirstName&&$validLastName&&$validEmail){
                      ...
                      Database::create_student($_SESSION['userId'],$_POST,$token);
...
//send the message, check for errors
                  ...
                  <input id="reset-username" type="hidden" class="form-control resetpass-userName"  name="role" value="student"><br/>
