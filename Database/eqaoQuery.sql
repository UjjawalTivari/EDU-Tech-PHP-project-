...
update question_6 set image = "2012_gr6_quest4.jpg" where quest_id = 46;
update question_6 set quest_text = "If the equation x + 4 = 12 is true, which of the following best describes the variable x? " where quest_id = 45;
select * from question_6 where quest_id = 20;

Update question_6 set quest_text = "If n x a = 24 and n x a + b = 33, what is the value of b?" where quest_id = 57;
Update question_6 set image =  "2009_gr6_quest17.jpg", ans1 = "2009_gr6_quest17ansa.jpg", ans2 = "2009_gr6_quest17ansb.jpg", ans3 = "2009_gr6_quest17ansc.jpg", ans4 = "2009_quest17ansd.jpg" where quest_id = 102;

select * from question_6;
alter table person modify password varchar(200);
select* from grades;
delete from grades where userId = 11;
select * from person;



INSERT INTO `eqaoproject`.`person` (`userId`, `userName`, `password`, `FirstName`, `LastName`, `Role`, `Email`) VALUES ('14', 'Nithya', 'asdf1234', 'Nithya', 'Humber', 'teacher', 'eqaotestprep@gmail.com');
INSERT INTO `eqaoproject`.`person` (`userId`, `userName`, `password`, `FirstName`, `LastName`, `Role`, `Email`) VALUES ('15', 'Katie', 'nhjk1234', 'Katie', 'Sullivan', 'student', 'eqaotestprep@gmail.com');
INSERT INTO `eqaoproject`.`person` (`userId`, `userName`, `password`, `FirstName`, `LastName`, `Role`, `Email`) VALUES ('16', 'Sweta', 'zxcv1234', 'Swetalina', 'Sahoo', 'student', 'eqaotestprep@gmail.com');
INSERT INTO `eqaoproject`.`person` (`userId`, `userName`, `password`, `FirstName`, `LastName`, `Role`, `Email`) VALUES ('17', 'Ujjawal', 'qwer1234', 'Ujjawal', 'Tivari', 'student', 'eqaotestprep@gmail.com');
INSERT INTO `eqaoproject`.`person` (`userId`, `userName`, `password`, `FirstName`, `LastName`, `Role`, `Email`) VALUES ('18', 'Preet', 'nmbv5678', 'Preet', 'Achariya', 'student', 'eqaotestprep@gmail.com');
INSERT INTO `eqaoproject`.`person` (`userId`, `userName`, `password`, `FirstName`, `LastName`, `Role`, `Email`) VALUES ('19', 'Ash', 'bbbb6666', 'Aishwariya', 'Gokhale', 'student', 'eqaotestprep@gmail.com');

INSERT INTO `eqaoproject`.`teacher` (`teacherId`, `school`, `schoolBoard`) VALUES ('14', 'Humber', 'Toronto');

INSERT INTO `eqaoproject`.`teacher_student`
(`teacherId`,
`childId`)
VALUES
(14,
...
INSERT INTO `eqaoproject`.`grades` (`userId`, `Test1_score`, `Test2_score`, `Test3_score`) VALUES ('15', '12', '15', '18');
INSERT INTO `eqaoproject`.`grades` (`userId`, `Test1_score`, `Test2_score`, `Test3_score`, `Test4_score`) VALUES ('16', '11', '17', '9', '10');
INSERT INTO `eqaoproject`.`grades` (`userId`, `Test1_score`) VALUES ('17', '16');
INSERT INTO `eqaoproject`.`grades` (`userId`, `Test1_score`, `Test2_score`, `Test3_score`, `Test4_score`, `Test5_score`) VALUES ('18', '3', '2', '7', '5', '5');
INSERT INTO `eqaoproject`.`grades` (`userId`, `Test1_score`, `Test2_score`, `Test3_score`) VALUES ('19', '20', '19', '19');
